...
public class myRobot
{
	...
	{
		// Operator
		boolean selectPress = armJoystick.getRawButton(1);
		if (selectPress && climberHelper == false)
		{
			climberOut = !climberOut;
			climberSol1.set(climberOut);
			climberSol2.set(!climberOut);
			climberHelper = true;
		}
		else if (!selectPress)
			climberHelper = false;		
		...
		boolean climbPressDown = armJoystick.getRawButton(5);
	...
	{
		double speed = 0.4;
		double drive1Duration = 3.1;
		double turnSpeed = 0.5;
		double turnDuration = 0.5;
		double drive2Duration = 2.0;
		double waitDuration = 1.0;
		double reverseDuration = 2.0;
		double turnbackDuration = 0.5;
		double finalDriveDuration = 2.0;
